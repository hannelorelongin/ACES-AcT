...
* `pipeline/`
    ...
    * `3_Map` : describes the characterization of one of the phage-encoded acetyltransferases, renamed Map
        ...
        * `methylation_analysis`: contains all code related to the methylome analysis comparing Map-expressing versus control *P. aeruginosa* PAO1 strains, as performed by @LucoDevro   
* `associated_data/`
